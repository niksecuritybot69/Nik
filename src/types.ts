...
export interface ChatConfig {
  ...
  forceJoinChannel2: string | null; // optional 2nd required channel, same format as forceJoinChannel
  forceJoinInviteLink2: string | null; // link shown on the 2nd "Subscribe" button
...
export const defaultChatConfig = (): ChatConfig => ({
  ...
  forceJoinChannel2: null,
  forceJoinInviteLink2: null,
